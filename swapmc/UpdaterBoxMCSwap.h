...
// inclusion guard
#ifndef _UPDATER_HPMC_BOX_SWAP_MC_
#define _UPDATER_HPMC_BOX_SWAP_MC_

/*! \file UpdaterBoxMCSwap.h
    \brief Declaration of UpdaterBoxMCSwap
*/
...
*/
class UpdaterBoxMCSwap : public Updater
    {
    public:
        //! Constructor
        ...
        */
        UpdaterBoxMCSwap(std::shared_ptr<SystemDefinition> sysdef,
        ...
        */
        ...
        hpmc_boxmc_counters_swap_t getCounters(unsigned int mode=0);
    ...
    private:
        std::shared_ptr<IntegratorHPMCSwap> m_mc;     //!< HPMC integrator object
        ...
        hpmc_boxmc_counters_swap_t m_count_total;          //!< Accept/reject total count
        hpmc_boxmc_counters_swap_t m_count_run_start;      //!< Count saved at run() start
        hpmc_boxmc_counters_swap_t m_count_step_start;     //!< Count saved at the start of the last step
...
//! Export UpdaterBoxMCSwap to Python
void export_UpdaterBoxMCSwap(pybind11::module& m);

} // end namespace hpmc

#endif // _UPDATER_HPMC_BOX_SWAP_MC_
