...
set(HOOMD_JIT_LIB ${HOOMD_ROOT}/jit/_jit${PYTHON_MODULE_EXTENSION})
set(HOOMD_JIT_LLVM_LIB ${HOOMD_ROOT}/jit/lib_jit_llvm.so)
...
set(HOOMD_LIBRARIES ${HOOMD_LIB} ${HOOMD_COMMON_LIBS} ${HOOMD_HPMC_LIB})
